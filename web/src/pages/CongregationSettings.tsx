...
import style from "./CongregationSettings.module.css";
...
const LoansCsvUrlInfo = ({}) => (
  <InfoBox title={"Early Access Feature: Integrate with territory loans data from Google Sheets"}>
    <p>If you keep track of your territory loans using Google Sheets, it's possible to export the data from
      ...
      handle the territory loans accounting all by itself, but in the meanwhile this workaround gives some
      of the benefits.</p>
    ...
    <p>The <i>Staleness</i> column should indicate the number of months since the territory was last loaned
      or returned.</p>
...
const CongregationSettings = ({}) => {
  ...
  return <Formik
    initialValues={{
      ...
      experimentalFeatures: !!congregation.loansCsvUrl,
    } as FormValues}
    validate={values => {
        ...
        <fieldset>
          ...
          <div className="pure-controls">
            <label className="pure-checkbox">
              <Field name="experimentalFeatures" type="checkbox"/> {t('CongregationSettings.experimentalFeatures')}
            </label>
          </div>
