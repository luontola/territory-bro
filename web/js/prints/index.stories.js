...
storiesOf('Printouts', module)
  .add('TerritoryCard', () =>
    <Box>
      <TerritoryCard territory={territory101}
                     congregation={demoCongregation}
                     mapRaster={mapRasters[0]}/>
    </Box>)

  .add('NeighborhoodCard', () =>
    <Box>
      <NeighborhoodCard territory={territory101}
                        congregation={demoCongregation}
                        mapRaster={mapRasters[0]}/>
    </Box>)
  ...
  .add('RuralTerritoryCard', () =>
    <Box>
      <RuralTerritoryCard territory={territory101}
                          congregation={demoCongregation}
                          mapRaster={mapRasters[0]}/>
    </Box>)
  ...
  .add('RegionPrintout', () =>
    <Box>
      <RegionPrintout region={subregionKatajanokka}
                      congregation={demoCongregation}
                      mapRaster={mapRasters[0]}/>
    </Box>)
  ...
  .add('RegionPrintout, multi-polygon', () =>
    <Box>
      <RegionPrintout region={subregionKaivopuisto}
                      congregation={demoCongregation}
                      mapRaster={mapRasters[0]}/>
    </Box>)
  ...
  .add('RegionPrintout, congregation', () =>
    <Box>
      <RegionPrintout region={demoCongregation}
                      congregation={demoCongregation}
                      mapRaster={mapRasters[0]}/>
    </Box>);
